...
const en: Record<string, string> = {
  ...
  "mcp.mcp.quickInstallDesc": "Works in Cursor, Claude Code, Windsurf, VS Code Copilot, and Codex. Your AI will auto-configure the MCP server and start setup.",
...
const zh: Record<string, string> = {
  ...
  "mcp.mcp.quickInstallDesc": "支持 Cursor、Claude Code、Windsurf、VS Code Copilot 和 Codex。AI 会自动配置 MCP 服务器并引导设置。",
